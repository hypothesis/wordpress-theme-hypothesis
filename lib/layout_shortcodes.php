<?php
  ...
  function bioPic($atts) {
    ...
    return do_shortcode('<div class="picunit tipper" data-toggle="modal" data-target="#'.$hash.'" >
  ...
  function bioInfo($atts, $content=null) {
    ...
    return do_shortcode('<div class="modal fade" id="'.$hash.'"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
